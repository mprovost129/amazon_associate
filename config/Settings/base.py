...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'amazon'),
...
# Storefront display limits
HOME_SECTIONS_LIMIT = 6
HOME_UNCATEGORIZED_LIMIT = 8
HOME_FEATURED_PRODUCTS_LIMIT = 8
HOME_FEATURED_COLLECTIONS_LIMIT = 4
HOME_FEATURED_GUIDES_LIMIT = 3
HOME_POPULAR_TAGS_LIMIT = 12
SEARCH_PRODUCTS_PER_PAGE = 24
CATEGORY_FEATURED_LIMIT = 8
RELATED_PRODUCTS_LIMIT = 4
PERFORMANCE_TOP_LIMIT = 10
PERFORMANCE_RECENT_CLICKS_LIMIT = 25
